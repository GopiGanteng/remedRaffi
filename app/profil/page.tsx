// pages/profile.tsx atau app/profile/page.tsx (tergantung Next.js version)
...
const ProfilePage = () => {
  const userData = {
    ...
    bio: "Seorang frontend developer yang passionate dalam membangun pengalaman web yang menarik dan responsif. Berpengalaman dalam React, Next.js, dan TypeScript.",
    avatar: "/image/.jpeg", // Ganti dengan path avatar Anda
    coverImage: "/gp/.jpeg ", // Ganti dengan path cover image
    ...
    socialLinks: {
      ...
      portfolio: "https://ahmadrizki.dev"
    }
  };
          ...
          <div className="px-6 py-8 border-b border-gray-200">
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-lg text-blue-600 font-medium">{userData.title}</p>
                <p className="text-gray-600 mt-2">{userData.location}</p>
                
                {/* Social Links */}
                <div className="flex justify-center md:justify-start space-x-4 mt-4">
                  {userData.socialLinks.github && (
                    <a href={userData.socialLinks.github} className="text-gray-400 hover:text-gray-600">
                  ...
                  {userData.socialLinks.linkedin && (
                    <a href={userData.socialLinks.linkedin} className="text-gray-400 hover:text-blue-600">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
